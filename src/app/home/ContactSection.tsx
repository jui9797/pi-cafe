  ...
  return (
    <section className="py-16 w-full bg-white dark:bg-[#1a1412] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-2 md:px-4 relative z-10">
        ...
        >
          <h2 className="text-3xl lg:text-4xl font-[family-name:var(--font-playfair)] font-bold text-coffee-primary dark:text-coffee-secondary mb-4">
            {t.title}
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col justify-center space-y-6">
            <motion.div
              ...
              className="space-y-3"
            >
              <h3 className="text-xl font-[family-name:var(--font-playfair)] font-bold text-coffee-primary dark:text-coffee-secondary">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                <div className="w-12 lg:w-16 h-12 lg:h-16 bg-[#25D366] rounded-full flex items-center justify-center mb-4 shadow-lg shadow-[#25D366]/30">
                  <MessageCircle className="text-white w-8 h-8" />
                </div>
                <span className="text-[10px] lg:text-[16px] font-semibold text-coffee-primary dark:text-coffee-secondary">
                  {t.whatsapp}
                </span>
              </motion.a>
              ...
              >
                <div className="w-12 lg:w-16 h-12 lg:h-16 bg-coffee-accent rounded-full flex items-center justify-center mb-3 shadow-lg shadow-coffee-accent/30">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-2 lg:p-4 border-2 border-dashed border-coffee-primary/20 rounded-xl flex items-center gap-6"
            >
              ...
              <div>
                <p className="text-sm opacity-60 uppercase lg:tracking-widest font-bold">
                  Email Us
                </p>
