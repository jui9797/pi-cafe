...
const Navbar = () => {
  ...
  return (
    <nav
      className={`w-full z-50 transition-all duration-300 ${isHome ? "absolute top-0 bg-transparent" : "sticky top-0 bg-coffee-bg/90 backdrop-blur-md border-b border-coffee-secondary/20 shadow-sm"}`}
    >
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex justify-between items-center">
        {/* Logo */}
        <Link
          href="/"
          className="font-[family-name:var(--font-playfair)] text-2xl font-bold tracking-tight text-coffee-primary"
        >
          Pi Cafe
        </Link>
